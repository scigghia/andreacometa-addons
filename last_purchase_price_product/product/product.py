...
#    Copyright (C) 2004-2011 www.andreacometa.it (<www.andreacometa.it>). All Rights Reserved
#
...
class product_template(osv.osv):
    ...
    _columns = {
        'cost_method': fields.selection([('standard','Standard Price'), ('average','Average Price'), ('lpp', 'Last Purchase Price')], 'Costing Method', required=True,
